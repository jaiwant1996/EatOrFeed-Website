...
//position: fixed;
   // top: 50%;
	...
	background: rgba(47, 72, 220, 0.47);
	//opacity: 0.3;
...
echo "Howdy, ";
echo ucfirst($_SESSION['sessionUser']);
?><font size="6"><br><?php
echo "We currently have these options available."?></font><br>
  <?php

$admin = "admin";

  $servername = "localhost";
  $username = "ithinkx1_jaiwant";
  $password = "jaiwantbhushaN1";
  $dbname = "ithinkx1_users";
  ...
  if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ?><font size="5"><div class="jumbotron2"><?php
      echo "Feeder: " . $row["feeder"]. " | Name: " . $row["itemName"]. " | Item Description " . $row["itemDescription"]. "<br>";
      ?></div></font><?php
    }
  } else {
    echo "0 results";
...
Click here to go
<input type="submit" value="Logout"  class="btn btn-default btn-lg">
</form>
